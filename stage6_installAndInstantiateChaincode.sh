...
docker exec -it cli peer chaincode install -n $CHAINCODE_NAME -v $CHAINCODE_VERSION -l $BUILDLANGUAGE -p /opt/gopath/src/github.com/chaincode/buy_sell/$BUILDLANGUAGE/
